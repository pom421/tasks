...
import { describeMigration } from './migrations.ts';
...
const file = process.env.TASKS_DB || path.join(ROOT, 'data', 'tasks.db');
const store = new Store(file);
const migrated = describeMigration(file, store.migration);
