...
1. Installer **Node.js 22.13 ou plus** : https://nodejs.org (vérifier avec `node --version`)
2. Récupérer le code :
   ```sh
...
Options : `PORT=8080 npm start` pour changer de port, `TASKS_DB=~/taches.db npm start` pour un autre fichier de base.
Tests : `npm test`.
